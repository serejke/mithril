...
impl Certificate {
    ...
    pub fn dummy_multisig() -> Result<Self, String> {
        let hash = "61b241a842ae986e54df26a43f5ebef2c6876d1b6fba5122cb20ca77df74131f";
        let previous_hash = "6cb7696b7faceb7da5e42bb9ee4fd68f794ca42361e45df83221f4a51c25bf7f";
